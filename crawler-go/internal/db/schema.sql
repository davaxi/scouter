...
-- ---------------------------------------------------------------------------
-- sitemap_urls — DERIVED. Page ids listed in the crawl's sitemap(s), written by
-- the CH sitemap analysis. page_metrics.in_sitemap is derived from it.
-- ---------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS scouter.sitemap_urls
(
    crawl_id  Int32,
    id        FixedString(8)
)
